...
{
    progression = (progression == 0.0 ? 1.0 : 0.0);

    CHECK_RESULT(gEventInstance.setParameterValue("Progression", progression));

    console.log("------------- TOGGLED PROGRESSION TO " + progression);
}
...
function initApplication() 
{
    ...
    CHECK_RESULT( gSystem.getEvent("event:/Music/Music", outval) );
