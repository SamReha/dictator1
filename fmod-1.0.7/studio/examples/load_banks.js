...
function loadBank(method)
{
    ...
    else if (method == 1.0 || method == 2.0) // 1 == LoadBank_MemoryPoint, 2 == LoadBank_MemoryPoint
    {
        ...
        result = FMOD.ReadFile(gSystemLowLevel, "/" + filename, outval);    // Use a little helper function to load a file into memory.
        
        memoryPtr = outval.val;
        memoryLength = memoryPtr.length;
        ...
        FMOD.Memory_Free(memoryPtr);                                         // Because the memory for the file came from fmod.  use little helper function to free it.
