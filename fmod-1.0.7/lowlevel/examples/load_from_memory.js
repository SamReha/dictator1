...
FMOD['TOTAL_MEMORY'] = 64*1024*1024;    // FMOD Heap defaults to 16mb which may be enough for this demo, but set it differently here for demonstration (64mb)
...
function main()
{
    ...
    FMOD.Debug_Initialize(FMOD.DEBUG_TYPE_MEMORY | FMOD.DEBUG_DISPLAY_LINENUMBERS | FMOD.DEBUG_LEVEL_LOG);
