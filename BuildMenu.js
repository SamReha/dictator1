...
var BuildMenu={
	...
	createNew: function(highData){
		...
		var buySchoolBtn = MainGame.game.make.button((bm.width/6), (bm.height/8), 'small_generic_button', function(){
		...
		var buyParkBtn = MainGame.game.make.button((bm.width/6), (bm.height*3/8), 'small_generic_button', function(){
			Hud.beginBuilding(buildMenu, buySchoolBtn, 'school');},
			buildMenu, 0, 1, 2, 3);
		...
		var buyFactoryBtn = MainGame.game.make.button((bm.width/6), (bm.height/8), 'small_generic_button', function(){
		...
		var buyArmyBaseBtn = MainGame.game.make.button((bm.width/6), (bm.height/8), 'small_generic_button', function(){
		...
		var buyFarmBtn = MainGame.game.make.button((bm.width/6), (bm.height*5/8), 'small_generic_button', function(){
			Hud.beginBuilding(buildMenu, buyFarmBtn, 'arableFarm');},
			buildMenu, 0, 1, 2, 3);
