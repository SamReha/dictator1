...
var Hud = {    
    createNew: function() {
        ...
        var buyMansionBtn = MainGame.game.make.button(100, MainGame.game.world.height-100, 'buttonSprite', null, buildMenu, 0, 1, 2, 3);
        buyMansionBtn.anchor.y = 1;  // Anchor on bottom left corner
        var mansionText = MainGame.game.make.text(0, -10, "Buy Mansion\n $10", style);
        mansionText.anchor.set(0);
        buyMansionBtn.addChild(mansionText);
        bureauGroup.addChild(buyMansionBtn);

        var buySuburbBtn = MainGame.game.make.button(230, MainGame.game.world.height-100, 'buttonSprite', null, buildMenu, 0, 1, 2, 3);
        buySuburbBtn.anchor.y = 1;  // Anchor on bottom left corner
        bureauGroup.addChild(buySuburbBtn);

        var buyApartmentBtn = MainGame.game.make.button(360, MainGame.game.world.height-100, 'buttonSprite', null, buildMenu, 0, 1, 2, 3);
        buyApartmentBtn.anchor.y = 1;  // Anchor on bottom left corner
        bureauGroup.addChild(buyApartmentBtn);

        var buySchoolBtn = MainGame.game.make.button(490, MainGame.game.world.height-100, 'buttonSprite', null, buildMenu, 0, 1, 2, 3);
        buySchoolBtn.anchor.y = 1;  // Anchor on bottom left corner
        bureauGroup.addChild(buySchoolBtn);

        var buyFactoryBtn = MainGame.game.make.button(620, MainGame.game.world.height-100, 'buttonSprite', null, buildMenu, 0, 1, 2, 3);
        buyFactoryBtn.anchor.y = 1;  // Anchor on bottom left corner
        merchantGroup.addChild(buyFactoryBtn);

        var buyArmyBaseBtn = MainGame.game.make.button(750, MainGame.game.world.height-100, 'buttonSprite', null, buildMenu, 0, 1, 2, 3);
