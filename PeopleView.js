...
var PeopleContractView={
	...
	createNew: function(personDataRef){
		...
		v.cancelButton=MainGame.game.add.button((v.width*1/2),(v.height*8/9),
			'small_generic_button',function(){
			console.log("================= cancle button pressed");
			console.log(".. and the parent is:",v.parent);
			console.log(".. and the game is:",v.game);
			console.log(".. and the button is:",this.name);
			v.destroy();
		},v.cancelButton,0,1,2);
